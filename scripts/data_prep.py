...
def encode_ordinal(housing_cat):
    ...
    output_file = os.path.join(OUTPUT_PATH, "codificacao_ordinal.csv")
...
def encode_one_hot(housing_cat):
    ...
    output_file = os.path.join(OUTPUT_PATH, "1hot.csv")
...
class CombinedAttributesAdder(BaseEstimator, TransformerMixin):
    ...
    def transform(self, x, y=None):
        ...
        output_file = os.path.join(OUTPUT_PATH, "dados_transformados.csv")
